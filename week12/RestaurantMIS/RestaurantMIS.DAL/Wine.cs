...
namespace RestaurantMIS.DAL
{
	...
	public class Wine
	{
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from Wine");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Wine(");
		...
		public void Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Wine ");
			strSql.Append(" where ID=@ID ");
			OleDbParameter[] parameters = {
					new OleDbParameter("@ID", OleDbType.Integer,4)};
			parameters[0].Value = ID;
		...
		public RestaurantMIS.Model.Wine GetModel(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,Name,Type,Unit,YesterdayStorkNum,TodayInNum,TodayOutNum,TodayStorkNum,Price,IncomeSum,LogDate,Memo from Wine ");
			strSql.Append(" where ID=@ID ");
			OleDbParameter[] parameters = {
					new OleDbParameter("@ID", OleDbType.Integer,4)};
			parameters[0].Value = ID;

			RestaurantMIS.Model.Wine model=new RestaurantMIS.Model.Wine();
        ...
        public string GetYesterdayStork(DateTime date, string name)
        {
            ...
            strSql.Append(" FROM Wine Where LogDate<= #");
            strSql.Append(date);
