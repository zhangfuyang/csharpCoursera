...
class Test
{
	...
	public static void TestAdapter()
	{
		...
		string strConn = @"Provider=Microsoft.Jet.OLEDB.4.0;" + @"Data Source=D:\CsExample\ch10\BIBLIO.MDB";
		...
		while( MyReader.Read() )
		{
			Console.WriteLine( MyReader.GetString(1) + MyReader["Name"].ToString() + MyReader[2].ToString());
		}
